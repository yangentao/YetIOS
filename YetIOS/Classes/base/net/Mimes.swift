...
public class Mimes {
	public static let OCTET_STREAM = "application/octet-stream"
	public static let XML = "application/xml"
	public static let JSON = "application/json"

	private static var mimeMap: [String: String] = [:]
	public static subscript(_ ext: String) -> String {
		if mimeMap.isEmpty {
			makeMimeMap(&mimeMap)
		}
		if let idx = ext.lastIndex(of: ".") {
			let s = ext[ext.index(after: idx)...]
			return mimeMap[String(s)] ?? OCTET_STREAM
		} else {
			return mimeMap[ext] ?? OCTET_STREAM
		}
	}

	public static func of(ext: String) -> String {
		self[ext]
	}

	fileprivate static func makeMimeMap(_ map: inout [String: String]) {
