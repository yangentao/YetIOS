...
public class LayoutParam {
	...
	@discardableResult
	public func widthFill() -> LayoutParam {
		self.width = MatchParent
		return self
	}

	@discardableResult
	public func heightFill() -> LayoutParam {
		self.height = MatchParent
		return self
	}

	@discardableResult
	public func width(_ w: CGFloat) -> LayoutParam {
		self.width = w
		return self
	}

	@discardableResult
	public func height(_ h: CGFloat) -> LayoutParam {
		self.height = h
		return self
	}

	@discardableResult
	public func weight(_ w: CGFloat) -> LayoutParam {
		self.weight = w
		return self
	}

	@discardableResult
	public func gravityX(_ g: GravityX) -> LayoutParam {
		self.gravityX = g
		return self
	}

	@discardableResult
	public func gravityY(_ g: GravityY) -> LayoutParam {
		self.gravityY = g
		return self
	}
...
public extension UIView {
	...
	var layoutParam: LayoutParam? {
		get {
			return getAttr("__linearParam__") as? LayoutParam
		}
		set {
	...
	@discardableResult
	func lp(_ width: CGFloat, _ height: CGFloat) -> LayoutParam {
